    ...
    grunt.initConfig({
        ...
        sass: {
            ...
            dist: {
                ...
                files: [
                    {'onepress-plus.css': 'assets/sass/onepress-plus.scss'}
                ]
            }
        },
        ...
        compress: {
            main: {
                options: {
					archive: 'onepress-plus-v' + pkgInfo.version + '.zip',
                    mode: 'zip'
                },
                files: [
                    {
        ...
        replace: {
            theme_main: {
                src: ['onepress-plus.css', 'assets/sass/onepress-plus.scss'],
                overwrite: true,
                replacements: [
                    {
